...
public class TMProGameObject 
{
    ...
    public static void SetObjectParent(Transform obj) {
		...
		Undo.RegisterCreatedObjectUndo(obj, "TMPro Create GameObject Extension");
	...
	private static bool EventSystemExists() {
		return (Object.FindObjectsOfType<EventSystem>().Length != 0);
	}
	...
	private static Transform CreateCanvas() {
		...
		Undo.RegisterCreatedObjectUndo(newCanvas, "TMPro Create GameObject Extension");
	...
	private static void CreateEventSystem() {
		if (!EventSystemExists()) {
			...
			Undo.RegisterCreatedObjectUndo(e, "TMPro Create GameObject Extension");
		}
	}
